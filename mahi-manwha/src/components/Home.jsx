           ...
           <ul className="text-white flex flex-row flex-nowrap overflow-x-auto space-x-4 pb-4 -mx-5 px-5 custom-scrollbar">
                {topSeries.map((currelem) => (
                    <li
                        ...
                        className="flex-shrink-0 w-[calc(25%-1rem)] sm:w-[calc(20%-0.8rem)] md:w-36 h-37 flex flex-col items-center text-center p-2 rounded-lg shadow-lg  transition duration-200 cursor-pointer"
                        key={currelem._id}

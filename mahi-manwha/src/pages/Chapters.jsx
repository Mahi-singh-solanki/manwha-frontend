...
return currseries
    ...
    return (
        <div className="min-h-screen text-white bg-gradient-to-b from-[#0B0F19] to-[#111827] pb-24">
            ...
            <div className="px-10 py-5 flex items-center gap-3 bg-black/40 backdrop-blur-md sticky top-0 z-50" onClick={()=>navigate("/")}>
                <ArrowLeft className="cursor-pointer" />
                <span className="text-lg font-medium">Back</span>
            </div>

 
            <div className="relative px-10 py-14 flex gap-12 items-center overflow-hidden">
                ...
                <div className="relative max-w-3xl">
                    ...
                    <h1 className="text-sm sm:text-5xl font-bold mb-4">
                        {series.title}
                    </h1>
                    ...
                    <div className="grid sm:grid-cols-4 gap-2 sm:gap-6 mb-8">
                        ...
                        <div className="bg-white/5 p-2 px-7 sm:p-5 rounded-2xl backdrop-blur-md">
                            ...
                            <p className="text-sm sm:text-2xl text-center font-bold mt-2">{series.chapters.length}</p>
                        </div>
                    ...
                    <div className="flex sm:flex-row flex-col gap-4">
                        <button className="bg-white/5 sm:px-8 py-3 rounded-xl font-semibold hover:scale-105 transition" onClick={() => handleChapter(series.chapters[0]._id)}>
                            Start Reading
                        </button>
                    ...
                    {series.chapters.map((chapter) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <p className="text-lg font-semibold" style={{color:chapter.read_status?"gray":"white"}}>
                            ...
                            <button className="bg-purple-600/30 hover:bg-purple-900/50 px-6 py-2 rounded-xl transition" onClick={() => handleChapter(chapter._id)}>
                                Read
                            </button>
                        </motion.div>
                    ))}
